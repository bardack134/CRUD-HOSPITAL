...
class PatientInformationJP(models.Model):
    ...
    class Meta:
        verbose_name = '患者情報'  # Nombre singular para la interfaz administrativa

        verbose_name_plural = '患者情報'  # Nombre plural para la interfaz administrativa
