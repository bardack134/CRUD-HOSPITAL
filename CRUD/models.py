...
class PatientInformation(models.Model):
    ...
    class Meta:
        verbose_name = 'Patient Information'  # Nombre singular para la interfaz administrativa

        verbose_name_plural = 'Patients Information'  # Nombre plural para la interfaz administrativa
